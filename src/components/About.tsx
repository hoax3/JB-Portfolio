...
export const About = () => {
  const certs = [
    ...
    <Link to="https://www.comptia.org/certifications/a"  style={{ textDecoration: 'none', color: 'inherit' }} target='_blank'>A+</Link>,
  ...
  return (
    <div className="about-main">
        ...
        <article>
          <h3>About Me</h3>
            <p>Just another nerd in the world who wants to help other nerds become more nerdy. Currently a Cloud Security Engineer focusing on CSPM across AWS, Azure, and GCP. I have worked as a SOC analyst, security engineer, and Splunk consultant. I'm always ready to take on new challenges. </p>
            <p>Throughout this site, you'll find my projects I have created and blogs to help others. If you want to get in touch, pop over to the Contact section.</p>
          <h3>Skills</h3>
            <div style={{
