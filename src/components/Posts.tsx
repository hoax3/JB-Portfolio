  ...
  return (
    <div className='container'>
      ...
      <Link to={"/coming"} target='_blank' className="posts-card">
          <img src='../../public/amplify.png' width='170px' height={'120px'} style={{borderRadius:'5px'}}></img>
          <h3>AWS Amplify</h3>
          <p>Getting started with deploying a full stack app on AWS Amplify</p>
      </Link>
      <Link to={"/coming"} target='_blank' className="posts-card">
          <img src='../../public/wikijs.jpeg' width='170px' height={'140px'} style={{borderRadius:'5px'}}></img>
          <h3>WikiJs</h3>
          <p>Deploying WikiJs on Portainer</p>
      </Link>
      <Link to={"https://github.com/hoax3/Splunk"} target='_blank' className="posts-card">
          <img src='../../public/splunk-img.jpeg' width='170px' height={'100px'} style={{borderRadius:'5px'}}></img>
